...
"===" создает линию тоньше и располагается рядом с текстом который хоите отделить. а также определяет текст над ней как заголовок
===
...
имеет тот же принциа что и в разделе 5.3, но с использование двойного символа ~~

### 5.7 Не нумерованные строки и подстроки
для ненумерованных строк и используют символы - + * в любом порядке и последовательности. 
+ Строка1
- Строка2
* Строка3
  
для создания подстрок используются теже символы, но с отступами в четыре пробела или Tab
...
точки подстрок создаются автомотически и и не влияют на выбор символа

### 5.8 Пронумерованные строки и подстроки
...
однако, если вы измените перый номер списка с 1. на 7.
...
нумерация всего списка измениться и будет начинаться уже с 7. даже если остальные номера остануться прежними
